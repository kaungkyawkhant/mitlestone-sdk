...
namespace ControllerMonitor.Background
{
    ...
    public class ControllerMonitorBackgroundPlugin : BackgroundPlugin
    {
        ...
        public override void Init()
        {
            ...
            _thread.Name = "ControllerMonitor Background Thread";
            _thread.Start();
        ...
        private void Run()
        {
            EnvironmentManager.Instance.Log(false, "ControllerMonitor background thread", "Now starting...", null);
            while (!_stop)
            {
                // Do some work here.
            ...
            EnvironmentManager.Instance.Log(false, "ControllerMonitor background thread", "Now stopping...", null);
            _thread = null;
        }
    }
}
