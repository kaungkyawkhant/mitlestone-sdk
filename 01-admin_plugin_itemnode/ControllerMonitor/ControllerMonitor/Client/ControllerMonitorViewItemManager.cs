...
namespace ControllerMonitor.Client
{
    ...
    /// </summary>
    public class ControllerMonitorViewItemManager : ViewItemManager
    {
        private Guid _someid;
        private string _someName;
        private List<Item> _configItems;

        public ControllerMonitorViewItemManager() : base("ControllerMonitorViewItemManager")
        {
        }
        ...
        public override void PropertiesLoaded()
        {
            ...
            _configItems = Configuration.Instance.GetItemConfigurations(ControllerMonitorDefinition.ControllerMonitorPluginId, null, ControllerMonitorDefinition.ControllerMonitorKind);
        ...
        {
            return new ControllerMonitorViewItemUserControl(this);
        }
        ...
        {
            return new ControllerMonitorPropertiesUserControl(this);
        }
