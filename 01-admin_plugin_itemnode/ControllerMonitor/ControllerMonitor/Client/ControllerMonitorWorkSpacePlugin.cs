...
{
    public class ControllerMonitorWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return ControllerMonitorDefinition.ControllerMonitorWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new ControllerMonitorWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
