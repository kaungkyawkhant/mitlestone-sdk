...
namespace ControllerMonitor.Client
{
    ...
    /// </summary>
    public class ControllerMonitorViewItemPlugin : ViewItemPlugin
    {

        public ControllerMonitorViewItemPlugin()
        {
        }
        ...
        {
            get { return ControllerMonitorDefinition.ControllerMonitorViewItemPlugin; }
        }


        public override System.Drawing.Image Icon
        {
            get { return ControllerMonitorDefinition.TreeNodeImage; }
        }
        ...
        {
            return new ControllerMonitorViewItemManager();
        }
