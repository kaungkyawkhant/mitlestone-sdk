...
namespace ControllerMonitor
{
    ...
    public class ControllerMonitorDefinition : PluginDefinition
    {
        ...
        internal static Guid ControllerMonitorBackgroundPlugin = new Guid("5062f433-2cfd-486e-8504-70409a1fa226");
        ...
        public override void Init()
        {
            ...
            _backgroundPlugins.Add(new ControllerMonitorBackgroundPlugin());
        }
