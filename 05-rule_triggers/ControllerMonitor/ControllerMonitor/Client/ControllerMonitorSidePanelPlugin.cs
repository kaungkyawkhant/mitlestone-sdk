...
namespace ControllerMonitor.Client
{
    ...
    /// </summary>
    public class ControllerMonitorSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        {
            return new ControllerMonitorSidePanelUserControl();
        }
        ...
        {
            get { return ControllerMonitorDefinition.ControllerMonitorSidePanel; }
        }
        ...
        {
            get { return "ControllerMonitor Side panel"; }
        }
