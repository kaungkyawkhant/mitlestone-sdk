...
namespace ClientPlugins.Client
{
    ...
    /// </summary>
    public partial class ClientPluginsPropertiesUserControl : PropertiesUserControl
    {
        ...
        public ClientPluginsPropertiesUserControl(ClientPluginsViewItemManager viewItemManager)
        {
