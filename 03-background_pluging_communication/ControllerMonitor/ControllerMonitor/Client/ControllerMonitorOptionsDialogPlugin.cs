...
namespace ControllerMonitor.Client
{
    ...
    /// </summary>
    public class ControllerMonitorOptionsDialogPlugin : OptionsDialogPlugin
    {
        ...
        {
            LoadProperties(true);
            return new ControllerMonitorOptionsDialogUserControl();
        }
        ...
        {
            get { return ControllerMonitorDefinition.ControllerMonitorOptionsDialog; }
        }
        ...
        {
            get { return "ControllerMonitor Options"; }
        }
