...
namespace ControllerMonitor.Client
{
    ...
    /// </summary>
    public partial class ControllerMonitorViewItemUserControl : ViewItemUserControl
    {
        #region Component private class variables

        private ControllerMonitorViewItemManager _viewItemManager;
        ...
        /// <summary>
        /// Constructs a ControllerMonitorViewItemUserControl instance
        /// </summary>
        public ControllerMonitorViewItemUserControl(ControllerMonitorViewItemManager viewItemManager)
        {
