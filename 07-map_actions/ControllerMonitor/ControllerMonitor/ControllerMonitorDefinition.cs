...
namespace ControllerMonitor
{
    ...
    public class ControllerMonitorDefinition : PluginDefinition
    {
        ...
        internal static string GateOpenCommand = "GateOpen";
        internal static string GateCloseCommand = "GateClose";
        ...
        public override void Init()
        {
            ...
            {
                new MapAlarmContextMenu("Open gate", GateOpenCommand, null),
                new MapAlarmContextMenu("Close gate", GateCloseCommand, null),
            };
            ...
            _itemNodes.Add(new ItemNode(ControllerMonitorKind, Guid.Empty,
                                         ...
                                         Category.Text, true,
                                         ItemsAllowed.Many,
                                         new ControllerMonitorItemManager(this, ControllerMonitorKind),
                                         null
                                         )
            {
                ContextMenu = _controllerCM,
                MapIcon = ControllerMonitor.Properties.Resources.Controller
            }
                                         );
