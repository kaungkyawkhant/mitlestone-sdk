...
namespace ControllerMonitor.Background
{
    ...
    public class ControllerMonitorBackgroundPlugin : BackgroundPlugin
    {
        ...
        {
            get { return ControllerMonitorDefinition.ControllerMonitorBackgroundPluginId; }
        }
        ...
        private void HandleEvent(string eventText)
        {
            EventHeader eventHeader = new EventHeader()
            {
                ...
                Message = eventText,
                Name = _connectedController.Name,
                Source = new EventSource { FQID = _connectedController.FQID, Name = _connectedController.Name },
                CustomTag = "<My><MiniXml>With no data</MiniXml></My>"
            };
            ...
            EventServerControl.Instance.ItemStatusChanged(_connectedController);
        }
